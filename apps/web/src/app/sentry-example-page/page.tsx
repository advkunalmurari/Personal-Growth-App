...
function SentryExamplePageContent() {
  ...
  return (
    <div>
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://personal-growth-app.sentry.io/issues/?project=4511021141459024"
          >
            Issues Page
          </a>
      ...
      <style>{`
        ...
        h1 { font-size: 20px; }
        .description { text-align: center; max-width: 500px; }
        .flex-spacer { flex: 1; }
        .success { color: green; }
        .success_placeholder { height: 46px; }
        .connectivity-error { color: red; }
      `}</style>
    </div>
  );
}
